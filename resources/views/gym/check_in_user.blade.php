                ...
                <div class="dropdown" style="float: right;">
                    ...
                    <ul class="dropdown-menu " style="width: 80%;margin-left: -64px;">
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_in_user_week') }}" enctype="multipart/form-data" >
                                @csrf
                                <button class="btn btn-primary" type="submit" style="width:100%">Week</button>
                            </form>
                        </li>
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_in_user_month') }}" enctype="multipart/form-data" >
                                @csrf
                                <button class="btn btn-primary" type="submit" style="width:100%">Month</button>
                            </form>
                        </li>
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_in_user_year') }}" enctype="multipart/form-data" >
                                @csrf
                    ...
                    <div class="col-lg-1 " style="margin-top: -3%;">
                        <div class="dropdown ">
                                ...
                                <ul class="dropdown-menu " style="width: 80%;margin-left: -141px;margin-top: 13px;">
                                    ...
                                    <li class="list-group-item"><a href="{{url('user_chk_in/'.$user_chk->user_id)}}">Session History</a></li>
                                </ul>
