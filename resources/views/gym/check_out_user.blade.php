    ...
    <div class="container">
        <div class="row p-lg-3 mt-lg-5">
            <div class="col-lg-6 text-center">
                <h5> <a href="{{ route('home') }}">CHECK-IN USERS</a> </h5>

            </div>
            <div class="col-lg-6 text-center">
                <h5> <a href="{{ route('check_out_user') }}">CHECK-OUT USERS</a></h5>
                ...
                <div class="dropdown"  style="float: right;">
                    ...
                    <ul class="dropdown-menu " style="width: 80%;margin-left: -64px;">
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_out_user_week') }}" enctype="multipart/form-data" style="">
                                @csrf
                                <button class="btn btn-primary" type="submit" style="width:100%">Week</button>
                            </form>
                        </li>
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_out_user_month') }}" enctype="multipart/form-data" style="">
                                @csrf
                                <button class="btn btn-primary" type="submit" style="width:100%">Month</button>
                            </form>
                        </li>
                        <li class="list-group-item">
                            <form method="POST" action="{{route('check_out_user_year') }}" enctype="multipart/form-data" style="">
                                @csrf
        ...
        <div class="row p-lg-3">
            <div class="col-lg-12">
                <h5>Total Users {{ $user_chk->count() }}</h5>
            </div>
        </div>
    </div>
        <div class=" container pl-lg-3 pr-lg-3">
            ...
            <div class="row p-lg-5" style="background-color: #ffffff">
                ...
                <div class="col-lg-6">
                    <h5>{{ $user_chk->name }}</h5>
                    <p class="float-left pt-3">{{ date('H:i:s', strtotime($user_chk->check_out)) }}</p>
                    <p class="float-right pt-3">{{ date('d.F.Y', strtotime($user_chk->check_out)) }}</p>
                </div>
                <div class="col-lg-3">
                </div>
                <div class="col-lg-1 " style="margin-top: -3%;">
                    <div class="dropdown ">
                            ...
                            <ul class="dropdown-menu " style="width: 80%;margin-left: -141px;margin-top: 13px;">
                                <li class="list-group-item"><a href="{{ url('view_profile/'.$user_chk->user_id) }}">View Profile</a></li>
                                <li class="list-group-item"><a href="{{url('user_chk_out/'.$user_chk->user_id)}}">Session History</a></li>
                            </ul>
