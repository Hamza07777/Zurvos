      ...
      <div class="container" style="padding: 0px;">
         ...
         <div class="row" style="background-color: #E6E6E6;height: 220px;">
            <div class="col-lg-12 text-center">
                <img src="{{asset('public/userimage/'.Auth::guard('admin')->user()->image)}}" class="avatar-lg rounded-circle  mt-lg-5" alt="Shreyu" style="">
         ...
         <form method="POST" action="{{ route('admin_profile_update_save') }}" enctype="multipart/form-data">
           @csrf
