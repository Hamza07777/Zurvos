    ...
    <div class="container">
        <div class="row p-lg-3 mt-lg-5">
            <div class="col-lg-6 text-center">
                <h5> <a href="{{ route('gym_manager_user_chk_in') }}">USER CHECK-IN</a> </h5>

            </div>
            <div class="col-lg-6 text-center">
                <h5> <a href="{{ route('gym_manager_user_chk_out') }}">USER CHECK-OUT</a></h5>
        ...
        <div class="row p-lg-3">
            <div class="col-lg-12">
                <h5>User Total Checkout {{ $user_chk->count() }}</h5>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-1 " style="margin-top: -3%;">
                    <div class="dropdown ">
                            ...
                            <ul class="dropdown-menu " style="width: 80%;margin-left: -141px;margin-top: 13px;">
                                {{-- <li class="list-group-item"><a href="{{ route('view_user_profile',$id) }}">View Profile</a></li> --}}
