...
<body style="background-image: url('{{asset('public/assets/ZURVOS_ASSETS/IMAGES/WEB/Sign_up2.png')}}'); background-size: 100% 100%;">
        ...
        <div class="card col-xs-4 col-sm-4 col-md-6 col-lg-3" style="width: 30rem; margin-top: 100px;  border-radius: 20px; background-color:  #eaeafa;">
            <div class="card-body">
                <h5 class="card-title text-center" style="margin-top: 50px; margin-bottom: 50px"><b>Additional Information</b></h5>
                     <form method="POST" action="{{route('influence.register') }}">
                        @csrf
                        <div class="form-group" style="margin-left: 20px;">
                            <label for="exampleInputUsername1">User Name</label>

                            <input id="user_name" type="user_name" class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ old('user_name') }}" required autocomplete="user_name" autofocus placeholder="User name">
