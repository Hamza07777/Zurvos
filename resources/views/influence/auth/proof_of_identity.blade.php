        ...
        <div class="card col-xs-4 col-sm-4 col-md-6 col-lg-3" style="width: 20rem; margin-top: 100px;  border-radius: 20px; background-color:  #eaeafa;">
            <div class="card-body">
                <h5 class="card-title text-center" style="margin-top: 50px; margin-bottom: 50px"><b>Proof of Identity </b></h5>
                     <form method="POST" action="{{route('influence.proof_of_identity_save') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group" style="margin-left: 20px;">
                            <label for="charges">Add Charges</label>

                            <input id="charges" type="text" class="form-control @error('charges') is-invalid @enderror" name="charges" value="{{ old('charges') }}"  autocomplete="charges" autofocus placeholder="58">
                            <p> Add your cahrges</p>
                                @error('paypalemail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cover_image" class="p-0 form-control @error('cover_image') is-invalid @enderror" required name="cover_image" type="file" accept="image/jpeg, image/png, application/pdf" value="{{ old('cover_image') }}" required style="border: none"/>
                                @error('cover_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
