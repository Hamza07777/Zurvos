        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <nav class="nav nav-pills flex-column flex-sm-row" style="background: #ffffff">
              <a class="flex-sm-fill text-sm-center nav-link " href="{{route('free_video_page')}}">Free Videos</a>
              <a class="flex-sm-fill text-sm-center nav-link active" href="{{route('paid_video_page')}}">Paid Videos</a>
            </nav>
          </div>
        </div>
        <div class="row"> 
