        ...
        <!-- Ionicons -->
        <link href="{{asset('public/admin/css/ionicons.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="{{asset('public/admin/css/AdminLTE.css')}}" rel="stylesheet" type="text/css" />
