<div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
        ...
        <li>
                                 ...
                                 <img src="{{asset('public/Partner_image/'.Auth::guard('partner')->user()->image)}}" class="avatar-sm rounded-circle mr-2" alt="Shreyu" />
                                ...
                                <h6 class="pro-user-name mt-2 mb-0">
                                     User
                                    {{ ucfirst(Auth::guard('partner')->user()->name)}}
                            ...
                            <li class="d-none d-sm-block">
                                <div class="dropdown" >
                                    ...
                                    <ul class="dropdown-menu " style="width: 80%;margin-left: -141px;margin-top: 13px;">
                                        <li class="list-group-item"><a href="{{ route('partner_admin_profile_update') }}">My Profile</a></li>
