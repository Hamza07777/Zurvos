      ...
      <div class="container" style="padding: 0px;">
         ...
         <div class="row" style="background-color: #E6E6E6;height: 220px;">
            <div class="col-lg-12 text-center">
                <img src="{{asset('public/Partner_image/'.Auth::guard('partner')->user()->image)}}" class="avatar-lg rounded-circle  mt-lg-5" alt="Shreyu" style="">
               ...
               {{-- <img src="{{asset('public\assets\ZURVOS_ASSETS\RAW_IMAGES\camera.png')}}" class=" rounded-circle" alt="Shreyu" width="5% " style="z-index: 2; margin-left: -5%; background-color: #ffffff;" /> --}}
                <h5>{{ ucfirst(Auth::guard('partner')->user()->name)}}</h5>  
           

            </div>
         </div>
         <form method="POST" action="{{ route('partner_admin_profile_update_save') }}" enctype="multipart/form-data">
           @csrf
