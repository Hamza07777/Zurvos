        ...
        <div class="card col-xs-4 col-sm-4 col-md-6 col-lg-3" style="width: 20rem; margin-top: 100px;  border-radius: 20px; background-color:  #eaeafa;">
            <div class="card-body">
                <h5 class="card-title text-center" style="margin-top: 50px; margin-bottom: 50px"><b>Address Details</b></h5>
                     <form method="POST" action="{{route('vendor.address_detail') }}">
                        @csrf
                        ...
                        <div class="form-group" style="margin-left: 20px;">
                            ...
                            <input id="store_name" type="text" class="form-control @error('store_name') is-invalid @enderror" name="store_name" value="{{ old('store_name') }}"  autocomplete="store_name" autofocus placeholder="Store Name">
